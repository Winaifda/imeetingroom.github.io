...
<h3><img src="img/icon/64/search_page.png">ตรวจสอบรายการที่จองห้อง <a href="#">
	...
	?>
      ...
      <div class="input-data-arrow">
        <form method="post" action="check_befor.php" id="formsearch">
	...
	?>
	  ...
	  <table class="data1">
		...
		?>
        <tr class="data1">
          <td class="data1" width="4%" align="center"><?	if($objResult10["mstatus"]=='N')
			{
          ...
          <td class="data1" width="21%"><?=Datethai($objResult10["strdate"]);?>
              <?=$objResult10["strtime"];?></td>
          <td class="data1" width="21%"><?=Datethai($objResult10["enddate"]);?>
              <?=$objResult10["endtime"];?></td>
